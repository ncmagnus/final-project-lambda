...
Next we will find the optimal dynamic treatment rule for this simulated data. The optimal dynamic treatment rule is the treatment regime that results in the optimal expected outcome. This provides the best method of assigning treatment specific to an individuals covariates. 
