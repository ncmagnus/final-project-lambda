...
resultssimple
```
The outputted results from sdtr include gcomp_simple, this is the difference in expected outcome under the simple rule and expected outcome under the comparison group. IPTW_simple gives the same information as gcomp_simple, it is simply transformed. Additionally, IPTW_simple_DR is double robust, 
